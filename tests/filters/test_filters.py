...
class TestFoodbankFilters(unittest.TestCase):
    ...
    def test_resource_type_meal_excludes_combo(self):
        """Filtering by 'Meal' excludes 'Food Bank' and combo types."""
    ...
    def test_eligibility_filter_seniors(self):
        """Seniors filter matches '60+' and 'Older Adults'."""
    ...
    def test_empty_eligibility_means_no_filtering(self):
        """Empty eligibility selection should pass all rows."""
    ...
    def test_empty_eligibility_and_days_with_open_only(self):
        """With empty eligibility and days, only open_only applies."""
    ...
    def test_distance_filter_with_user_location(self):
        """Locations beyond max distance are excluded."""
    ...
    def test_combined_filters(self):
        """All filter dimensions applied together narrow to one result."""
        mask = get_foodbank_mask(
            self.df,
            resource_type="Meal",
            open_only=True,
