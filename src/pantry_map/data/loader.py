...
def get_transit_df():
    data_path = os.path.join(BASE_DIR, "pantry_map", "data", "raw", "all_shapes.csv")
    ...
    grouped_df['color'] = grouped_df['shape_id'].apply(color_from_id) # TODO: ungroup, each segment is a line. colors are grouped.
    return grouped_df
